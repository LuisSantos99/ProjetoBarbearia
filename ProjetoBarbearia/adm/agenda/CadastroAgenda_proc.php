...
$dtFinal = str_replace('T', ' ', $dtFinal);
	...
	if (!empty($idCliente)){
		$sql =  "INSERT INTO AGENDA (IDCLIENTE,IDBARBEIRO,DATAHORA,DATAHORAFIM,COLOR) VALUES ($idCliente,$idBarbeiro,'$dtInicial','$dtFinal','')";
	}else{
		$sql =  "INSERT INTO AGENDA (IDBARBEIRO,DATAHORA,DATAHORAFIM,COLOR) VALUES ($idBarbeiro,'$dtInicial','$dtFinal','')";
	}

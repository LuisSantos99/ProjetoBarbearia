...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-06-2020 a las 20:29:09
...
--
ALTER TABLE `agenda`
  MODIFY `IDAGENDA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de la tabla `atendimento`
--
ALTER TABLE `atendimento`
  MODIFY `IDATENDIMENTO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de la tabla `atendi_itens`
--
ALTER TABLE `atendi_itens`
  MODIFY `IDATENDIMENTO_ITENS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `barbeiro`
--
ALTER TABLE `barbeiro`
  MODIFY `IDBARBEIRO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
